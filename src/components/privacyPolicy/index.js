                ...
                <div className="pt-10 pb-20 px-8 xl:px-0 flex flex-col gap-y-8 max-w-[1200px] w-full">
                    ...
                    <div className="flex flex-col gap-y-4">
                        <div className="flex gap-x-4 items-center">
                            <Icon icon={"tabler:lock"} width={25} height={25} />{" "}
                        ...
                        <div className="text-[#64748b]">
                            <p>
                                Welcome to{" "}
                                <b>Priyanshu Dev Portfolio</b> (the “Website”) — accessible at{" "}
                                <Link
                                    href="https://priyanshudev.site"
                                    target="_blank"
                                    className="text-primary hover:underline"
                                >
                                    https://priyanshudev.site
                                </Link>
                                . <br />
                                This Privacy Policy explains how{" "}
                                <b>Priyanshu Agrawal</b> (“I”, “me”, or “my”) collects, uses,
                                and protects your personal information when you visit or
                    ...
                    <div className="flex flex-col gap-y-4">
                        ...
                        <div className="flex text-[#64748b] flex-col gap-y-4">
                            <p>
                                I collect limited information to improve your experience and
                                communication. This may include:
                            </p>
                            <ul className="list-disc list-inside">
                                <li>
                                    <b>Contact Form Data: </b> Name, Email Address, and Message
                                    content when you use the contact form.
                                </li>
                                <li>
                                    <b>Subscriber Data: </b> Email address if you choose to
                                    subscribe for updates or newsletters.
                                </li>
                                <li>
                                    <b>Automatic Data (future): </b> In the future, I may use
                                    tools like Google Analytics or Cloudflare verification to
                                    collect anonymous usage statistics (e.g., pages visited,
                                    browser type, time spent).
                                </li>
                            </ul>
                            <p>
                                No sensitive personal data (like passwords or payment details)
                                is collected through this site.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col gap-y-4">
                        ...
                        <div className="flex text-[#64748b] flex-col gap-y-2">
                            ...
                            <p>
                                The website is hosted on <b>Render</b>, a trusted cloud hosting
                                platform with secure infrastructure.
                            </p>
                            <p>
                                While I take reasonable precautions, no online platform can
                    ...
                    <div className="flex flex-col gap-y-4">
                        ...
                        <div className="flex text-[#64748b] flex-col gap-y-2">
                            ...
                            <p>
                                In the future, third-party services (like Google Analytics or
                                Buy Me a Coffee integration) may set their own cookies for
                                analytics or personalization.
                            </p>
                            <p>
                                If implemented, visitors will be informed via an updated version
                                of this policy.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col gap-y-4">
                        ...
                        <div className="flex text-[#64748b] flex-col gap-y-4">
                            ...
                            <p>
                                These services may collect or process limited information under
                                their own privacy policies.
                            </p>
                            <p>
                                I encourage you to review their respective policies before
                    ...
                    <div className="flex flex-col gap-y-4">
                        ...
                        <div className="flex text-[#64748b] flex-col gap-y-4">
                            ...
                            <ul className="list-disc list-inside">
                                ...
                                <li>
                                    Unsubscribe from emails anytime by clicking the unsubscribe
                                    link (if applicable).
                                </li>
                                <li>Contact me directly for data-related concerns.</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col gap-y-4">
                        ...
                        <div className="flex text-[#64748b] flex-col gap-y-4">
                            ...
                            <p>
                                All updates will be posted on this page with a revised “Last
                                Updated” date.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col gap-y-4">
                        ...
                        <p>
                            This Privacy Policy is intended to provide transparency and align
                            with general data protection best practices.
                        </p>
                    </div>
                </div>
            </div>
